...
sns.heatmap(correlation_matrix,
            ...
            annot_kws={'size': 20 , 'weight': 'bold'},  # 放大数字
...
# Set title and labels 坐标轴刻度标签（PLQY, FWHM 等）加粗
plt.xlabel('')
plt.ylabel('')
plt.xticks(fontsize=20, rotation=0, ha='center', fontweight='bold')
plt.yticks(fontsize=20, rotation=0, fontweight='bold')

# 删除坐标轴旁边的刻度标记
plt.tick_params(axis='both', which='both', length=3,width=2)
